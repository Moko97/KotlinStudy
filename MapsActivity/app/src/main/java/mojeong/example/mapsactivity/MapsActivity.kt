package mojeong.example.mapsactivity
...
import mojeong.example.mapsactivity.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
     ...
     /*   val markerOptions = MarkerOptions()
            .position(LATLNG)
            .title("Marker is Seoul City Hall")
    ...
    */
        ...
        */
        ...
        var discripor = BitmapDescriptorFactory.fromBitmap(bitmapDrawable.bitmap)
